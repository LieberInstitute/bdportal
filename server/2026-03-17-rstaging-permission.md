...
For this app build, API base is hardcoded to `http://srv16.lieber.local:4095`, so frontend may hit Node directly instead of via `/sibdb/` proxy.
...
- The backend hardening is implemented as local file changes in this working copy.
