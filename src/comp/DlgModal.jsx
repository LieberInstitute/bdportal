...
export function DlgModal ( props ) {
 ...
 return (<Modal focus={true} fade={false} backdrop="static"
     ...
     <div className="modal-header app-bg pt-1 mt-0" style="height:32px;">
        <h5 className="modal-title" style="line-height:120%;">{title}</h5>
   ...
   { props.button && <Button type="submit" className="app-btn" disabled={!props.buttonEnable()}
    ...
    <Button color="secondary rounded-0" onClick={props.toggle}>
       {btnClose}
    </Button>
    </Row>
   </ModalFooter>
