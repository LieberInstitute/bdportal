...
import {RDataProvider, FltCtxProvider, useFltCtxUpdate, useRData, clearFilters,
   filterSet, applyFilterSet, getFilterData} from '../../comp/RDataCtx';
	...
	return (<div style={style}>
	  ...
	  <Col>
	    <Row>
	      <Col>
		    <Row> 
		       <FltMList id="proto" type="htoggle" width="25rem" data={dtaProto} filter={filterSet} onApply={applyFilter} updateFilter />
		    </Row>
			<Row>  
		       <FltMList id="dset" height="10rem" width="25rem" data={dtaDset} filter={filterSet} onApply={applyFilter} updateFilter />
		    </Row>
		  </Col>
		</Row>
 		<Row className="d-flex justify-content-center flex-nowrap">
			 <Col className="justify-content-end pr-1">
             <FltMList id="dx" width="13rem" data={dtaDx} filter={filterSet} onApply={applyFilter} updateFilter sort /> 
		   </Col>
		   <Col className="justify-content-begin ml-0 pl-0">
              <FltMList id="reg" width="14rem" height="8.1rem" data={dtaReg} filter={filterSet} onApply={applyFilter} updateFilter sort />
		   </Col>
        </Row>
	  </Col>
	  <Col >
